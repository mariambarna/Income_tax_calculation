...
<body style="width: 100vw">
  <div class="container">
    ...
    <li class="breadcrumb-item"><a href="agri.php">Agriculture</a></li>
  </ul>
                      <div class="row">
                        
                      </div>
                    </div>
                  <h2><i class="fa-sharp fa-solid fa-bag-shopping"></i> For Agriculture holder</h2>
<h4> Fill It With Accurate Information</h4>
   
<form action="server/agri.php" method="post" enctype="multipart/form-data">
