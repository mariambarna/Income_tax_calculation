...
<head>
    ...
    <link rel="stylesheet" href="../css/acomplain.css">
</head>
<body>
  <div class="container-fluid">
                ...
                <div class="header">
                  ...
                  <div class="col-2 ml-3 mt-1">
                      ...
                      <p>National Tax Calculation, Bangladesh</p>
                        <!-- <h5 style:"color:rgb(165, 70, 63);">জাতীয় রাজস্ব বোর্ড, বাংলাদেশ</h5> -->
                    </div>
                  </div>
    ...
    <li class="breadcrumb-item"><a href="acomplain.php">Complains</a></li>
  </ul>
                      <div class="row">
