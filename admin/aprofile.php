...
<body>
  <div class="container-fluid">
    ...
    <li class="breadcrumb-item"><a href="ahome.php">Home</a></li>
     <li class="breadcrumb-item"><a href="aprofile.php">Profile</a></li>
...
<div class="card-deck mt-5 mb-5 pt-3 ml-5 mr-5">
      ...
      <div class="card ">
        <div class="card-body text-center">
          <p class="card-text"><h2><a title="Dark Mode" href="amyprofile.php" ><i class="fa-solid fa-user-tie"></i>  My Profile</a> </h2></p>
      </div>
      </div>
      <div class="card ">
        <div class="card-body text-center">
         <p class="card-text"><h2><a title="Dark Mode" href="apass.php" ><i class="fa-solid fa-user-tie"></i>  Change Password</a> </h2></p>
      </div>
    </div>
  </div>
